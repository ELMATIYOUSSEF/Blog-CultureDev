<?php     
 ...
 if(isset($_POST['email'])) $loginController->SignIn();
?>
 <?php include('includes/alerts.php');?>
<div class="row login d-flex justify-content-center">
    <div class="col-8 d-flex justify-content-center">
            <form class="row g-3 w-50 " method="post" id="Login" >
                <h1 class=" fw-bold  font-monospace  text-center">Login</h1>
                    ...
                    <div class="col-12 ">
                        ...
                        <input type="password" onkeyup="submitsignin()" name="password" class="form-control" id="inputPassword4" placeholder="*********" required >
                        <div class="errormsg"></div>
                    </div>
                
                    <div class="col-12">
                        <button type="submit" id="btnSgnin" name="SignIn"  class="btn btn-primary">Sign in</button>
                    </div>
                    <p class=""><a href="Singin" class="text-decoration-none"> Create Account !! </a></p>
